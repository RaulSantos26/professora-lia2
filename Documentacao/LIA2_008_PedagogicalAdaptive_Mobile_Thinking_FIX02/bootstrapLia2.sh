...
LIA2_RELEASE=0.6.3-pedagogical-adaptive-mobile-thinking-fix02
...
setEnvKey "LIA2_RELEASE" "0.6.3-pedagogical-adaptive-mobile-thinking-fix02"

echo "[LIA2] Validando arquitetura do Student Web no repositório..."
...
docker compose --env-file "$ENV_FILE" -f "$COMPOSE_FILE" run --rm -e LIA2_PROCESSING_WORKER_ENABLED=false -e LIA2_PEDAGOGICAL_WORKER_ENABLED=false lia2-backend pytest -q
...
echo "[LIA2] Construindo e subindo o Pedagogical Engine + Adaptive Mobile + Thinking 008 FIX02..."
docker compose --env-file "$ENV_FILE" -f "$COMPOSE_FILE" up -d --build

echo
echo "[LIA2] Pedagogical Engine + Adaptive Mobile + Thinking 008 FIX02 iniciado."
